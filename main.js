document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!miniQuizForm || !btnMulaiQuiz || !tombolCek || !hasilQuiz) return;
  ...
  const resetQuiz = () => {
    hasilQuiz.innerHTML = '';
    miniQuizForm.querySelectorAll('.pertanyaan').forEach(q => q.classList.remove('benar', 'salah', 'aktif'));
    miniQuizForm.reset();
  };
